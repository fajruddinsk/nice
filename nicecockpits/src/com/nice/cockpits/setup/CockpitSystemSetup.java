 ...
 *
 */
package com.nice.cockpits.setup;
...
import com.nice.cockpits.constants.NiceCockpitsConstants;
 ...
 */
@SystemSetup(extension = NiceCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(NiceCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(NiceCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						NiceCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/nicecockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
