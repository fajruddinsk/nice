 ...
 *
 */
package com.nice.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("nicecockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("nicecockpits.product.externalTaxes"));
