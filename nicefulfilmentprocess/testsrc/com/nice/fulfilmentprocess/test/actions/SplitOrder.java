 ...
 *
 */
package com.nice.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(NiceFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(NiceFulfilmentProcessConstants.PARENT_PROCESS);
