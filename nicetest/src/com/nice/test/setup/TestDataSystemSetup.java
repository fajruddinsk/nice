...
import com.nice.test.constants.NiceTestConstants;
import com.nice.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = NiceTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/nicetest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/nicetest/import/reviews.impex");
			...
			importImpexFile(context, "/nicetest/import/cstickets.impex");
		}
	}
}
